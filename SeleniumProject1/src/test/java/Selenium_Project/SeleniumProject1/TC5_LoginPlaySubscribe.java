...
public class TC5_LoginPlaySubscribe
{
	...
	public void TestCase() throws InterruptedException
	{
        ...
        Thread.sleep(3000);
        WebElement subscribechannel = driver.findElement(By.xpath("//ytd-subscribe-button-renderer[@class='style-scope ytd-watch-metadata']//yt-button-shape[@class='style-scope ytd-subscribe-button-renderer']//div[@class='yt-spec-touch-feedback-shape__fill']"));
