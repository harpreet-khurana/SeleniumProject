...
public class TC7_LoginWatchlater 
{
	...
	public void TestCase() throws InterruptedException
	{
        ...
        WebElement watchLater = driver.findElement(By.xpath("//yt-formatted-string[@class='title style-scope ytd-guide-entry-renderer'][normalize-space()='Watch later']"));
        watchLater.click();
