...
public class TC3_LoginSubscriptions 
{
	...
	public void TestCase() throws InterruptedException
	{
        ...
        //Click Subscriptions
        WebElement subscriptions = driver.findElement(By.xpath("//yt-formatted-string[@class='title style-scope ytd-guide-entry-renderer'][normalize-space()='Subscriptions']"));
        subscriptions.click();
